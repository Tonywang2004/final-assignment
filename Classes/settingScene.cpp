...
void SettingScene::exitTheScene()
{
    ...
    // 设置按钮位置为右下角
    exitButton->setPosition(Vec2(origin.x + visibleSize.width * 0.95 - exitButton->getContentSize().width / 0.8,
                                 origin.y + exitButton->getContentSize().height / 0.6 + 15));
...
void SettingScene::conductSetMusic()
{
    ...
    volumeSlider->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height / 1.55));
...
void SettingScene::muteEffectCheckBox()
{
    ...
    if (mute_sound2 != NULL)
    {
        Size visibleSize = Director::getInstance()->getVisibleSize();
        Vec2 origin = Director::getInstance()->getVisibleOrigin();
        mute_sound2->setPosition(Vec2(origin.x + visibleSize.width / 2.2, origin.y + visibleSize.height / 2.5 - 20));
    ...
    muteEffectsCheckBox->setPosition(Vec2(origin.x + visibleSize.width / 1.75, origin.y + visibleSize.height / 2.5 - 20));
